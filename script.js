...
const emergencyPanel=document.querySelector('#emergency-request'); if(emergencyPanel){const emergencyToggle=document.createElement('button'); emergencyToggle.type='button'; emergencyToggle.className='button lime emergency-toggle'; emergencyToggle.textContent='Emergency maintenance request'; emergencyPanel.parentNode.insertBefore(emergencyToggle,emergencyPanel); emergencyPanel.hidden=true; emergencyToggle.addEventListener('click',()=>{emergencyPanel.hidden=!emergencyPanel.hidden; emergencyToggle.textContent=emergencyPanel.hidden?'Emergency maintenance request':'Hide maintenance request';});}
