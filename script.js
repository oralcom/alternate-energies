...
const whatsappNumber='+27635498662'; const whatsappUrl='https://wa.me/27635498662?text='+encodeURIComponent('Hello Alternate Energies, I would like to discuss a solar project.'); const wa=document.createElement('a'); wa.className='whatsapp-float'; wa.href=whatsappUrl; wa.target='_blank'; wa.rel='noopener'; wa.setAttribute('aria-label','Chat with Alternate Energies on WhatsApp'); wa.innerHTML='<span aria-hidden="true">◔</span><b>WhatsApp us</b>'; document.body.appendChild(wa); document.querySelectorAll('.contact-emails').forEach(block=>{if(!block.querySelector('.phone-contact')){const item=document.createElement('div');item.className='phone-contact';item.innerHTML='<span>WhatsApp enquiries</span><a href="'+whatsappUrl+'" target="_blank" rel="noopener">+27 63 549 8662</a>';block.appendChild(item);}});
